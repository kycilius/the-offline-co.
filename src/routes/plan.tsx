...
const ATMOSPHERES: Record<string, { label: string; copy: string }> = {
  dooars: { label: "🌿 Wild Silence", copy: "Forest immersion. Elephant safari. Tribal wisdom. No signal zones." },
  kandhamal: { label: "🏔️ First Light", copy: "Mountain sunrise. Tea estate walks. Campfire folk music. Birds before alarms." },
  birbhum: { label: "🌊 Salt & Stillness", copy: "The sea at 5am. Fishing villages. Someone’s grandmother’s recipe. Tide as your only notification." },
  satkosia: { label: "🐘 The Unhurried Wild", copy: "Dawn without a feed. Forest sounds. A naturalist who reads animals better than algorithms." },
...
> = {
  birbhum: {
    region: "Odisha Coast",
    place: "Salt & Stillness",
    stay: "A coastal homestay close to fishing villages, shared kitchens, and pre-dawn tide walks.",
    weather: "Salt-warm mornings, soft sea breeze, and slower evenings by the water.",
    pack: ["Light cotton layers", "Walking sandals", "A notebook", "One soft shawl for breezy mornings"],
    ...
    schedule: [
      ...
      "The sea at 5am with tide as the only notification",
      "Fishing village walk, shared lunch, and open-sky story circle",
      "Quiet morning tea before the return journey",
    ],
  },
  dooars: {
    region: "Jalpaiguri, North Bengal",
    place: "Gorumara, North Bengal",
    stay: "A forest-edge lodge run with local guides, simple rooms, and no-signal pockets of quiet.",
    ...
    schedule: [
      ...
      "Pre-dawn forest immersion and elephant-safari stillness",
      "Tribal wisdom, local kitchen lunch, and golden-hour walking circle",
      "Quiet tea before returning online differently",
    ],
  },
  kandhamal: {
    region: "Kandhamal, Odisha",
    place: "Lower Himalayas",
    stay: "A hill-country guesthouse close to tea estate walks, sunrise clearings, and cold evening air.",
    weather: "Cool mornings, crisp evenings, and first light moving through the hills.",
    ...
    schedule: [
      ...
      "Campfire folk music with gentle first conversations",
      "Mountain sunrise and tea-estate walk",
      "Local lunch, rest hours, and evening story circle",
      "Quiet morning reflection before departure",
    ],
  },
  satkosia: {
    region: "Central India Safari",
    place: "The Unhurried Wild",
    stay: "A forest-side safari stay with simple rooms, naturalist-led mornings, and sound-rich evenings.",
    weather: "Cool dawns, warm forest days, and quiet nights shaped by wilderness sounds.",
    pack: ["Earth-toned layers", "Closed walking shoes", "A light jacket", "Torch or headlamp"],
    img: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&w=1600&q=80",
    schedule: [
      "Arrival by the forest and offline transition",
      "Lantern dinner and slow introductions",
      "Dawn without a feed, guided by a naturalist",
      "Forest sounds, rest, and stories under open skies",
      "Quiet morning before returning online differently",
    ],
  },
  open: {
