...
const LANDSCAPES = [
  {
    ...
    icon: "🌿",
    title: "Wild Silence",
    description: "Forest immersion. Elephant safari. Tribal wisdom. No signal zones.",
    transitionTitle: "Wild Silence",
    transitionLines: [
      "Maybe deep forest calm is what your nervous system remembers.",
      "Maybe mystery feels better than another notification.",
      "Maybe silence is the ground you want to return to.",
    ],
  },
  {
    slug: "mountains",
    ...
    icon: "🏔️",
    title: "First Light",
    description: "Mountain sunrise. Tea estate walks. Campfire folk music. Birds before alarms.",
    transitionTitle: "First Light",
    transitionLines: [
      "Maybe you’re looking for a clearer kind of morning.",
      "Maybe the first light feels like permission to reset.",
      "Maybe openness arrives before the world starts asking things of you.",
    ],
  },
  {
    slug: "coastline",
    ...
    description: "The sea at 5am. Fishing villages. Someone’s grandmother’s recipe. Tide as your only notification.",
    transitionTitle: "Salt & Stillness",
    transitionLines: [
      "Maybe you’re drawn to warmth that doesn’t ask you to perform.",
      "Maybe softness feels like the bravest reset right now.",
      "Maybe human connection is easier when the tide sets the pace.",
    ],
  },
  {
    ...
    transitionLines: [
      "Maybe slow wilderness is how awe finds you again.",
      "Maybe forest sounds can replace the feed for a while.",
      "Maybe detachment feels less like absence and more like relief.",
    ],
  },
  {
    slug: "open",
