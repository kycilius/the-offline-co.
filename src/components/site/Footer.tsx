    ...
    <footer className="relative border-t border-paper/10 mt-12">
      <div className="container-page py-16 md:py-24 grid grid-cols-1 md:grid-cols-12 gap-10">
        <div className="md:col-span-5">
          ...
          <p className="mt-3 text-xs text-paper/45 tracking-[0.24em] uppercase">Find your people · Est. 2025</p>
        ...
        <div className="md:col-span-3">
          <p className="text-[0.7rem] tracking-[0.24em] uppercase text-paper/55 mb-4">Wander</p>
          <ul className="space-y-3 text-paper/70 text-sm">
            ...
            <li><a href="#where" className="hover:text-ember">Where We Go</a></li>
          </ul>
        </div>
        <div className="md:col-span-4">
          <p className="text-[0.7rem] tracking-[0.24em] uppercase text-paper/55 mb-4">Whisper</p>
          <p className="text-paper/70 text-sm leading-relaxed">
            Locations are not announced. Cohorts are not advertised.<br />
            If you're meant to be there, the email will find you.
          </p>
          <Link to="/questionnaire" className="ember-button mt-6">Begin the quiz</Link>
        </div>
      </div>
